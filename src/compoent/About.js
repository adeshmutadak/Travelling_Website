...
import AboutImg from '../Assets/team1.webp'
export default function About() {
  return (
    <div>
     
     <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-slate-400">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div className="w-full lg:w-8/12">
                    <img className="w-full h-full" src={AboutImg} alt="A group of People" />
                </div>
            </div>
            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                ...
                <div className="w-full lg:w-8/12 lg:pt-8 bg-black rounded">
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        ...
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            <img className="md:block hidden" src="https://i.ibb.co/fGmxhVy/Rectangle-119.png" alt="" />
